...
{
    [Table(Name = "MasterLocalFileNotificationEmailBodyTemplates")]
    public class MasterLocalFileNotificationEmailBodyTemplate : Sars.Systems.Data.DataAccessObject
    {
        public MasterLocalFileNotificationEmailBodyTemplate()
        {
        }

        public MasterLocalFileNotificationEmailBodyTemplate(string procedure, Dictionary<string, object> parameters)
