...
namespace Sars.Models.CBC
{
    ...
    public class CBCReport_Address : Sars.Systems.Data.DataAccessObject
    {
        public CBCReport_Address()
        {
        }
        public CBCReport_Address(string procedure, Dictionary<string, object> parameters) : base(procedure, parameters)
        {
        }
