<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="RejectedOutgoingCBCR.aspx.cs" Inherits="pages_Incomingcbcdeclataions" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <script>
        ...
        $(document).on("click", "[id*=lnkView]", function () {
            ...
            var id = $(rowContents[5]).find("input[name$=packageId]").val();

            var params = { packageId: id };
            $.ajax({
                type: "POST",
                url: './RejectedOutgoingCBCR.aspx/GetCommentsById',
                        ...
                        <fieldset>
                            ...
                            <table style="width: 80%">
                                <tr>
                                    ...
                                    <td>ReportingPeriod<span>:</span></td>
                                    <td style="width: 45%">
                            ...
                            <asp:GridView runat="server" ID="gvCBC" OnRowDataBound="gvCBC_RowDataBound"
                                ...
                                AutoGenerateColumns="False" CssClass="documents" DataKeyNames="Country,Period" EmptyDataText="NO REJECTED PACKAGES">
                                <Columns>
                                    ...
                                    <asp:TemplateField Visible="false">
                                        <ItemTemplate>
                                            <asp:Label Text='<%# Bind("Id") %>' ID="lblId" runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:LinkButton Text="View Comments" ID="lnkView" runat="server" />
                                             <input type="hidden" runat="server" id="packageId" value='<%#Eval("Id") %>'/>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:Button ID="btnGenerate" Visible="false" OnClick="btnGenerate_Click" runat="server" Text="Generate" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                                        <ItemTemplate>
