<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ApprovedOutgoingCBCR.aspx.cs" Inherits="pages_Incomingcbcdeclataions" %>
                    ...
                    <ContentTemplate>
                        <fieldset>
                            ...
                            <asp:GridView runat="server" ID="gvCBC" OnRowDataBound="gvCBC_RowDataBound"
                                ...
                                AutoGenerateColumns="False" CssClass="documents" DataKeyNames="Country,Period" EmptyDataText="NO APPROVED PACKAGES">
                                <Columns>
