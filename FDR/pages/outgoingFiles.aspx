<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="outgoingFiles.aspx.cs" Inherits="pages_acceptedsubmissions" %>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Registered Name">
                                ...
                                <ItemStyle HorizontalAlign="Left" />
                                  ...
                                  <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:HyperLink ID="lnkViewFiles" runat="server" NavigateUrl='<%#  string.Format("displayoutgoingfiles.aspx?submissionId={0}&bck={1}", Eval("submissionId"), Request.Url.PathAndQuery.ToBase64String())  %>' Text="View&nbsp;Files" CssClass="link-buttons"  ></asp:HyperLink>
