<%@ Page Title="" Language="C#" MasterPageFile="~/SiteNoScriptManager.master" AutoEventWireup="true" CodeFile="filedetails.aspx.cs" Inherits="pages_filedetails" %>
            ...
            <style>
                ...
                <fieldset>
                                <SCS:Toolbar ID="Toolbar1" runat="server" OnButtonClicked="Toolbar1_ButtonClicked"
                                    ...
                                    <Items>
                                        <SCS:ToolbarButton CausesValidation="True" CommandName="SAVE" Text="SAVE OUTCOME" ImageUrl="~/Images/Icons/save.png" />
