<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="displayOutgoingFiles.aspx.cs" Inherits="pages_displayOutgoingFiles" %>
                    ...
                    <div>
                        <table>
                            <tr>
                                ...
                                <td>
                                    <asp:Button runat="server" Text="Save" Visible="false" ID="btnSave" OnClick="btnSave_Click" /></td>
                                <td>
                                    <span onclick="return confirm('Are you sure you want to submit?');">
                                        <asp:Button runat="server" Text="Submit" ID="btnSubmit" OnClick="btnSubmit_Click" Visible="false" /></span>
                                </td>
                            </tr>
                        </table>
                    </div>
