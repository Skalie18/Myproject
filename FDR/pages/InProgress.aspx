<%@ Page Title="" MaintainScrollPositionOnPostback="true" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="InProgress.aspx.cs" Inherits="pages_inprogress" %>
        ...
        <div class="panel-body">
            <div class="page-container">
                    ...
                    <asp:GridView runat="server" AutoGenerateColumns="False" ID="gvMNE" CssClass="documents" AllowPaging="True" OnPageIndexChanging="gvMNE_PageIndexChanging" GridLines="Horizontal" OnRowCommand="gvMNE_RowCommand" OnRowDataBound="gvMNE_RowDataBound" EmptyDataText="NO FILE SUBMISSIONS">
                        ...
                        <%--    <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:LinkButton ID="lnkViewFiles" runat="server" CommandName="ViewFiles" CommandArgument='<%# Bind("submissionId") %>' Text="View Files"></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>--%>
