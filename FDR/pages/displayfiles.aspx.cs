...
public partial class pages_displayfiles : System.Web.UI.Page
{
    ...
    protected void FileOpenCommand(object sender, CommandEventArgs e)
    {
        if (e.CommandArgument != null)
        {
            ...
            if (gv.SelectedDataKey != null)
            {
                ...
                Response.Redirect(string.Format("filedetails.aspx?oId={0}&fId={1}&submissionId={2}&refNo={3}", e.CommandArgument, fileId, SubmissionId, _fileSubmission.TaxRefNo));
            }
        }
    }
}