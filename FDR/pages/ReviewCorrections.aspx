<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ReviewCorrections.aspx.cs" Inherits="pages_Incomingcbcdeclataions" %>
                    ...
                    <ContentTemplate>
                        <fieldset>
                            ...
                            <asp:GridView runat="server" ID="gvCBC" OnRowDataBound="gvCBC_RowDataBound"
                                ...
                                AutoGenerateColumns="False" CssClass="documents" DataKeyNames="Country,Period" EmptyDataText="NO CORRECTED PACKAGES TO RIVIEW">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Date" HeaderText="Date Corrected" DataFormatString="{0:yyyy-MM-dd HH:mm}" />
