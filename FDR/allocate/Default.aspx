<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="allocate_Default" %>
                ...
                <asp:GridView runat="server" AutoGenerateColumns="False" ID="gvMNE" CssClass="documents" AllowPaging="True" OnPageIndexChanging="gvMNE_PageIndexChanging" GridLines="Horizontal" OnRowCommand="gvMNE_RowCommand" OnRowDataBound="gvMNE_RowDataBound" EmptyDataText="NO FILE SUBMISSIONS">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Registered Name">
                           ...
                           <asp:TemplateField>
                            <ItemTemplate>
                                <asp:HyperLink ID="lnkAlocate" runat="server" NavigateUrl='<%#  string.Format("allocate.aspx?submissionId={0}&bck={1}", Eval("submissionId"), Request.Url.PathAndQuery.ToBase64String())  %>' Text="Allocate" CssClass="link-buttons"></asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:HyperLink ID="lnkViewFiles" runat="server" NavigateUrl='<%#  string.Format("~/pages/displayfiles.aspx?submissionId={0}&bck={1}", Eval("submissionId"), Request.Url.PathAndQuery.ToBase64String())  %>' Text="View&nbsp;Files" CssClass="link-buttons"></asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateField>
