...
public partial class queueMonitors_FDR_SUBMITCBCREPORT_RES : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (dataset.HasRows)
        {
            if (dataset.Tables.Contains("MessageIdentification") && dataset.Tables.Contains("ApplicationInformationResult"))
            {
